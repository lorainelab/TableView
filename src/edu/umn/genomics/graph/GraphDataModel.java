/*
 * @(#) $RCSfile: GraphDataModel.java,v $ $Revision: 1.6 $ $Date: 2004/08/02 20:23:35 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.6 $ $Date: 2004/08/02 20:23:35 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 */
            ...
            if (dataArray.getClass().isArray()) {
                ...
                if (dataArray.getClass().getComponentType().isPrimitive()) {
                    if (compClass.equals(Double.TYPE)) {
                        ...
                        System.arraycopy(da, 0, ds, 0, len);
