/*
 * @(#) $RCSfile: IndexSelectDrawable.java,v $ $Revision: 1.3 $ $Date: 2003/07/28 15:07:12 $ $Name: TableView1_3_2 $
 *
...
/**
 * Associates a Drawable for each index value based on whether the
 * index is selected in a ListSelectionModel.
 * @author       J Johnson
 * @version $Revision: 1.3 $ $Date: 2003/07/28 15:07:12 $  $Name: TableView1_3_2 $
 * @since        1.0
 */
public class IndexSelectDrawable implements IndexedDrawable {
  ...
  public IndexSelectDrawable(Drawable selectDrawable, IndexedDrawable indexedDrawable, ListSelectionModel lsm) {
   ...
   * @param drawable for selected indices.
   */
  ...
  /**
   * Sets the selection model newModel and registers
  ...
  /**
   * Returns the ListSelectionModel that is used to maintain the
   * selection state.
  ...
  /**
   * Set the indexed drawable of the graph item, which provides a drawable 
   * at each data point in this graph item.
   * @param indexedDrawable drawable for this graph item.
   */
