/*
 * @(#) $RCSfile: IndexSelectColor.java,v $ $Revision: 1.4 $ $Date: 2003/07/28 15:07:12 $ $Name: TableView1_3_2 $
 *
...
/**
 * Associates a Color value for each index value based on whether the 
 * index is selected in a ListSelectionModel.
 * @author       J Johnson
 * @version $Revision: 1.4 $ $Date: 2003/07/28 15:07:12 $  $Name: TableView1_3_2 $
 * @since        1.0
...
public class IndexSelectColor implements IndexedColor {
  ...
  public IndexSelectColor(Color selectColor, IndexedColor indexedColor, ListSelectionModel lsm) {
   ...
   * @param color for selected indices.
   */
  ...
  /**
   * Set the indexed color of the graph item, which will 
   * provide a color for each drawable in this graph item.
   * @param indexedColor color for this graph item.
   */
