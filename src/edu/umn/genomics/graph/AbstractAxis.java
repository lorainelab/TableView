/*
 * @(#) $RCSfile: AbstractAxis.java,v $ $Revision: 1.1 $ $Date: 2004/01/28 20:32:55 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.1 $ $Date: 2004/01/28 20:32:55 $ $Name: TableView1_3_2
 * $
 * @since AV1.0
 */
public class AbstractAxis implements Axis, Cloneable {
     ...
     * Sets the range of the Axis.
     *
     * @param range an array of length 2 holding the minimum and Maximum values
     * of the axis.
