/*
 * @(#) $RCSfile: GraphPoints.java,v $ $Revision: 1.8 $ $Date: 2004/01/28 20:32:58 $ $Name: TableView1_2 $
 *
 ...
 *
 * @author       J Johnson
 * @version $Revision: 1.8 $ $Date: 2004/01/28 20:32:58 $  $Name: TableView1_2 $ 
 * @since        1.0
 * @see DataModel
 */
public class GraphPoints extends AbstractGraphItem {
      ...
      for (int i = 0; i < points[0].length; i++) {
        ...
        if (indexedDrawable != null) {
          if (indexedDrawable instanceof IndexedDefaultDrawable) {
            ...
            idd.draw(g,points[0][i],points[1][i],i, defaultDrawable);
            continue;
          } 
  ...
  /**
   * Returns the data indices that intersects the given point.
   * @param p the point to test for intersection.
   * @param xAxis The X axis of the graph.
   * @param yAxis The Y axis of the graph.
