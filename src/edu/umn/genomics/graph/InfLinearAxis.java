/*
 * @(#) $RCSfile: InfLinearAxis.java,v $ $Revision: 1.6 $ $Date: 2004/01/28 20:32:58 $ $Name: TableView1_3_2 $
 *
 ...
 * @author       J Johnson
 * @version $Revision: 1.6 $ $Date: 2004/01/28 20:32:58 $  $Name: TableView1_3_2 $ 
 * @since        AV1.0
 */
public class InfLinearAxis extends LinearAxis {
  ...
  /** 
   * Create a InfLinearAxis with default values: 
   * min = -10, max = 10, and size = 0.
   */
  public InfLinearAxis() {
  }
  /** 
   * Create a InfLinearAxis with default values of min = -10, max = 10 
   ...
   *  Attemmpt to place the ticks at major numbers, for example:
