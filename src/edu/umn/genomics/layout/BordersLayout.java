/*
 * @(#) $RCSfile: BordersLayout.java,v $ $Revision: 1.3 $ $Date: 2002/07/30 19:44:58 $ $Name: TableView1_3_2 $
 *
 ...
 * </pre> As a convenience, BordersLayout interprets the absence of a string
 * specification the same as the constant
 * <code>CENTER</code>:
 * <pre>
 *    Panel p2 = new Panel();
 *    p2.setLayout(new BordersLayout());
 *    p2.add(new TextArea());  // Same as p.add(new TextArea(), BordersLayout.CENTER);
 * </pre> <p> The components are laid out according to their preferred sizes and
 * the constraints of the container's size. The
 * <code>NORTH</code> and
 * <code>SOUTH</code> components may be stretched horizontally; the
 * <code>EAST</code> and
 * <code>WEST</code> components may be stretched vertically; the
 * <code>CENTER</code> component may stretch both horizontally and vertically to
 * fill any space left over. Corners will match the dimension of the adjoining
 * border component. <p>
 *
 ...
 * @since JDK1.0
 */
public class BordersLayout implements LayoutManager2,
     ...
     * <code>NORTH</code> and
     * <code>BEFORE_FIRST_LINE</code> constants in a container whose orientation
     * is
     * <code>LEFT_TO_RIGHT</code>, only the
     ...
     * The horizontal gap is specified by
     * <code>hgap</code> and the vertical gap is specified by
     * <code>vgap</code>.
     *
     ...
     * <code>EAST</code>,
     * <code>WEST</code>, or
     * <code>CENTER</code>. <p> Most applications do not call this method
     * directly. This method is called when a component is added to a container
     * using the
     ...
     * <code>target</code> container using this layout manager. <p> This method
     ...
     * <code>target</code> container using this layout manager, based on the
     * components in the container. <p> Most applications do not call this
     * method directly. This method is called when a container calls its
    ...
    /**
     * Lays out the container argument using this border layout. <p> This method
     * actually reshapes the components in the specified container in order to
     * satisfy the constraints of this
     * <code>BordersLayout</code> object. The
     * <code>NORTH</code> and
     * <code>SOUTH</code> components, if any, are placed at the top and bottom
     * of the container, respectively. The
     * <code>WEST</code> and
     * <code>EAST</code> components are then placed on the left and right,
     * respectively. Finally, the
     * <code>CENTER</code> object is placed in any remaining space in the
     * middle. <p> Most applications do not call this method directly. This
    ...
    public void layoutContainer(Container target) {
        synchronized (target.getTreeLock()) {
            ...
            if ((c = getChild(SOUTH, ltr)) != null) {
                c.setSize(right - left, c.getSize().height);
                Dimension d = c.getPreferredSize();
                rb = new Rectangle(left, bottom - d.height, right - left, d.height);
                c.setBounds(rb);
    ...
    private Component getChild(String key, boolean ltr) {
        ...
        } else if (key.equals(NORTHEAST)) {
            result = northeast;
        } else if (key.equals(NORTHWEST)) {
            result = northwest;
        } else if (key.equals(SOUTHEAST)) {
            result = southeast;
        } else if (key.equals(SOUTHWEST)) {
            result = southwest;
