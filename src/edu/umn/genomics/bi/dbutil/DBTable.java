/*
 * @(#) $RCSfile: DBTable.java,v $ $Revision: 1.3 $ $Date: 2003/10/03 12:50:45 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.3 $ $Date: 2003/10/03 12:50:45 $ $Name: TableView1_3_2
 * $
 * @since 1.0
...
public class DBTable implements Comparable {
    ...
    public static DBTable getDBTable(DatabaseMetaData dbmd, ResultSet rs) throws SQLException {
        ...
        ArrayList colList = new ArrayList(DBColumn.getDBColumn(dbmd, dbTable));
    ...
    public Collection getColumnNames() {
        ArrayList v = new ArrayList(getColumnCount());
        for (int i = 0; i < getColumnCount(); i++) {
