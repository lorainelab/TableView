/*
 * @(#) $RCSfile: AboutDB.java,v $ $Revision: 1.1 $ $Date: 2003/07/28 16:36:18 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.1 $ $Date: 2003/07/28 16:36:18 $ $Name: TableView1_3_2
 * $
 * @since 1.0
...
public class AboutDB {
    ...
    public static TableModel getVersions(DatabaseMetaData dbmd) {
        ...
        return new DefaultTableModel((Object[][]) rows.toArray(), colNames.toArray());
    }
    ...
    public static TableModel getSQLKeywords(DatabaseMetaData dbmd) {
        ArrayList colNames = new ArrayList(1);
