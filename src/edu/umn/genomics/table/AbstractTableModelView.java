/*
 * @(#) $RCSfile: AbstractTableModelView.java,v $ $Revision: 1.9 $ $Date: 2004/05/13 20:29:35 $ $Name: TableView1_3_2 $
 *
 ...
 * @author       J Johnson
 * @version $Revision: 1.9 $ $Date: 2004/05/13 20:29:35 $  $Name: TableView1_3_2 $ 
 * @since        1.0
 * @see  ColumnMap
 * @see  TableContext
 ...
 */
public class AbstractTableModelView extends JPanel
  ...
  /**
   *  This adds this view as a listener to the TableModel 
   *  and to the ListSelectionModel.  Classes overriding this 
   *  method should call super.addListeners();
   */
  protected void addListeners() {
    if (tm != null) {
      tm.addTableModelListener((TableModelListener)this);
    }
    if (lsm != null) {
      lsm.addListSelectionListener((ListSelectionListener)this);
    }
  }
  ...
  public void cleanUp() {
    if (tm != null) {
      tm.removeTableModelListener((TableModelListener)this);
    }
    if (lsm != null) {
      lsm.removeListSelectionListener((ListSelectionListener)this);
    }
  }
   ...
   * @param setOperator the selection set operator to use.
   ...
   * This implementation does nothing, extending classes should override 
   * this method.
   ...
   * This implementation uses TableModel.getColumnName(int columnIndex) to 
   * find the column index for each name, then calls setColumns(int[] columns).
   * @param columns the indices of the columns to display.
   */
