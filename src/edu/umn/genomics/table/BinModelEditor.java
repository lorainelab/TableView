/*
 * @(#) $RCSfile: BinModelEditor.java,v $ $Revision: 1.2 $ $Date: 2004/08/12 21:00:02 $ $Name: TableView1_3_2 $
 *
...
public class BinModelEditor extends JPanel {
    ...
    static HashMap dateFieldHt = new HashMap();
    ...
    static HashMap calFieldHt = new HashMap();
