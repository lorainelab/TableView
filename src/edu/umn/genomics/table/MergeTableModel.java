/*
 * @(#) $RCSfile: MergeTableModel.java,v $ $Revision: 1.3 $ $Date: 2004/08/12 21:00:03 $ $Name: TableView1_3_2 $
 *
...
public class MergeTableModel extends AbstractTableModel implements TableModelListener {
     ...
     * @exception IndexOutOfBoundsException If the column count of the
     * tableModel does not match the column count of the existing tables.
     * @exception ClassCastException If the column classes of the tableModel do
     * not match the column classes of the existing tables.
     */
     ...
     * @param tableIndex the index of the referenced table
     * @param rowIndex the row whose value is to be queried
     * @param columnIndex the column whose value is to be queried see
