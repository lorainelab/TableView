/*
 * @(#) $RCSfile: AbstractHistogramViewND.java,v $ $Revision: 1.2 $ $Date: 2004/09/21 16:49:43 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.2 $ $Date: 2004/09/21 16:49:43 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 * @see ColumnMap
 * @see TableContext
...
public abstract class AbstractHistogramViewND extends AbstractTableModelView
    ...
    HashMap menuItemToBinModel = new HashMap();
    ...
    private ArrayList getTableColumnNames() {
    ...
    public void setColumns(int[] columns) {
        ...
        if (ctx != null && plotPanel != null) {
            ...
            ArrayList cmapList = new ArrayList();
