/*
 * @(#) $RCSfile: CellMap.java,v $ $Revision: 1.6 $ $Date: 2004/08/18 17:32:54 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.6 $ $Date: 2004/08/18 17:32:54 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 * @see SetOperator
...
public interface CellMap {
     ...
     *
     * @param index the index into the list of elements being mapped. return the
     ...
     * closest element. return the element that is mapped nearest to the the
     * mapValue.
     */
     ...
     * collection is numeric, else the number of discrete elements.
