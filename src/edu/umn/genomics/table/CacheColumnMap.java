/*
 * @(#) $RCSfile: CacheColumnMap.java,v $ $Revision: 1.15 $ $Date: 2004/08/18 17:32:54 $ $Name: TableView1_3_2 $
 *
...
public class CacheColumnMap extends BaseColumnMap {
     ...
     *
     * @param rowIndex the row in the table return the mapped value of the row
     */
    @Override
    ...
    public Object getValueAt(int rowIndex) {
        if (data != null) {
            if (data instanceof BitSet) {
                ...
                return rowIndex >= 0 ? ((BitSet) data).get(rowIndex) : null;
            } else if (isNumber) {
                if (nullCells != null && nullCells.get(rowIndex)) {
                    return null;
                }
     ...
     *
     * @param obj - the new value @rowIndex - the row whose value is to be set
     */
