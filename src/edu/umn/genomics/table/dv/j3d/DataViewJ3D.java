/*
 * @(#) $RCSfile: DataViewJ3D.java,v $ $Revision: 1.2 $ $Date: 2004/01/29 15:53:21 $ $Name: TableView1_3_2 $
 *
...
/**
 * @author J Johnson
 * @version $Revision: 1.2 $ $Date: 2004/01/29 15:53:21 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 */
public class DataViewJ3D extends DataView implements Serializable {
     ...
     */
    private HashMap bgToDMHash = new HashMap();
...
//System.err.println("setViewpoint \n" + viewTrans.toString());
    ...
    public void setViewAction(int viewAction) {
        ...
        switch (viewAction) {
            case NAVIGATE:
                for (Object e : dataMapName.values()) {
                    ((DataMapJ3D) e).doSelection(null, setOperator);
                }
                doNavigationBehavior(true);
                break;
            case SELECT_RECT:
                for (Object e : dataMapName.values()) {
                    ((DataMapJ3D) e).doSelection(canvas, setOperator);
                }
