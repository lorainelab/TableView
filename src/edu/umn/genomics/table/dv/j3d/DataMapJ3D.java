/*
 * @(#) $RCSfile: DataMapJ3D.java,v $ $Revision: 1.1 $ $Date: 2003/05/15 18:23:48 $ $Name: TableView1_3_2 $
 *
 ...
 * @version $Revision: 1.1 $ $Date: 2003/05/15 18:23:48 $ $Name: TableView1_3_2
 * $
 * @since dv1.0
 */
public class DataMapJ3D extends DataMap implements Serializable {
    ...
    String defaultPrimName = (String) GlyphJ3D.getGlyphTypes().get(0);
