/*
 * @(#) $RCSfile: GlyphJ3D.java,v $ $Revision: 1.1 $ $Date: 2003/05/15 18:23:50 $ $Name: TableView1_3_2 $
 *
...
/**
 * @author J Johnson
 * @version $Revision: 1.1 $ $Date: 2003/05/15 18:23:50 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 */
public class GlyphJ3D extends BranchGroup implements Serializable, Glyph {
     ...
     */
    private static ArrayList dataReps = new ArrayList();
    ...
    public static ArrayList getGlyphTypes() {
        return dataReps;
    }
