/*
 * @(#) $RCSfile: Selection.java,v $ $Revision: 1.2 $ $Date: 2003/07/28 15:07:19 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.2 $ $Date: 2003/07/28 15:07:19 $ $Name: TableView1_3_2
 * $
 * @since 1.0
...
public class Selection extends Behavior implements Serializable {
     ...
     * @param branchGroup The BranchGroup that contains the geometry to be
     * picked.
    ...
    public void processStimulus(Enumeration criteria) {
	    ...
	    /*
                         ...
                         * l=0;l<3;l++) { if (l == 0) System.out.print ("BOUNDS:
                         * "); if (l == 1) System.out.print ("GEOMETRY: "); if
                         * (l == 2) System.out.print ("GEOMETRY_INTERSECT_INFO:
                         * ");
                         *
