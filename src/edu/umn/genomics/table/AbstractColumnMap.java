/*
 * @(#) $RCSfile: AbstractColumnMap.java,v $ $Revision: 1.12 $ $Date: 2004/09/21 16:49:43 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.12 $ $Date: 2004/09/21 16:49:43 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 * @see SetOperator
...
public abstract class AbstractColumnMap implements Serializable, ColumnMap, CleanUp {
     ...
     * @param continuous if true map numeric and date values as a real number in
     * the range of values from the column, if false treat numbers as elements
     * of a set.
     */
    public AbstractColumnMap(TableModel tableModel, int column,
            boolean continuous) {
     ...
     *
     * @param stdDev the standard deviation of the values in this column in this
     * column.
     */
     ...
     *
     * @param row the row in the table return the mapped value of the row
     */
     ...
     * closest.. return the element that is mapped nearest to the mapValue.
     */
     ...
     * along the ColumnMap.
     *
     * @param buckets the number of divisions of the range of values. If the
     * value is zero, the default numbers of subdivisions be returned: 10 if the
     * column is numeric, else the number of discrete elements.
...
//System.err.println(this + "\tselectRange\t" + from + "\t" + to);
        ...
        switch (setOperator) {
            ...
            case SetOperator.INTERSECTION:
                ...
                try {
                    lsmOld = (DefaultListSelectionModel) ((DefaultListSelectionModel) lsm).clone();
                } catch (Exception ex) {
     ...
     */
    /**
     * Partition the column values text representation based on matches to the
     * array of regular expression patterns.
     *
     * @param regex The array of regular expression patterns upon which to
     * partition the values.
     * @return The PartitionIndexMap that partitions the values according to the
     * regular expressions.
     */
     ...
     *
     * @param calendarField The Calendar field upon which to partition the
     * values.
     * @return The PartitionIndexMap that partitions the values according to the
     * calendarField.
     */
     ...
     * @param calendarField The Calendar field upon which to partition the
     * values.
     * @param divisions The number of divisions of Calendar field values to
     * group together, e.g. Months divided into 4 groups yield Quarters of the
     * year.
     * @return The PartitionIndexMap that partitions the values according to the
     * calendarField.
     */
