/*
 * @(#) $RCSfile: BaseColumnMap.java,v $ $Revision: 1.5 $ $Date: 2004/08/18 17:32:54 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.5 $ $Date: 2004/08/18 17:32:54 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 * @see SetOperator
...
public class BaseColumnMap extends AbstractColumnMap
    ...
    HashMap colHash = null; // map cell value Object to an Elem Object
    ArrayList objList = null;    // sequential list of distinct cell value Objects
    ...
    protected void collectStats(HashMap colH) {
