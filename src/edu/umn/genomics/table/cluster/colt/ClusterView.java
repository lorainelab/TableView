/*
 * @(#) $RCSfile: ClusterView.java,v $ $Revision: 1.2 $ $Date: 2003/05/28 17:44:53 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.2 $ $Date: 2003/05/28 17:44:53 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 * @see ColumnMap
 * @see TableContext
...
public class ClusterView extends AbstractTableModelView
     ...
     * @param nodeidx the current node index, incremented after each node is
     * traversed
    ...
    private int traverse(TreeNode tn, int leafcnt, double parentDistance,
        ...
        segs[offset++] = y; // Y
/*
         * System.err.println(tn.toString() + " \tmlc " + leafcnt + " lc " + lc
         * + " pd " + parentDistance + " d " + distance); for (int i = 8, j =
