 ...
 * greater than the length of the source index. <br> A source index
 * <code><b>i</b></code> maps to destination indices
 * <code>srcToDst[<b>i</b>]</code> to
 * <code>srcToDst[<b>i</b>+1]</code>. The number of destination indices equals
 * <code>srcToDst[<b>i</b>+1] - srcToDst[<b>i</b>]</code>. <br> <br> For example
 * given srcToDstIndex array:
 * <code> [0 2 5 6 6 8] </code> the following shows the mapping from the 5
 * elements in the src to the 8 elements in the dst index.
 * <pre>
 * <br>src      [0 1 2 3 4]
 * <br>srcToDst [0 2 5 6 6 8]
 * <br>dst      [0 0 1 1 1 2 4 4]  (shows the src index mapped to)
 * </pre> <ul> <li>getSrcSize() returns 5 <li>getDstSize() returns 8
 * <li>getDsts(1) returns [2 3 4] (indices starting from 2 but less than 5)
 * <li>getDst(1) returns 2 (the first index mapped to) <li>getDsts(3) returns [
 * ] <li>getDst(1) returns -1 (indicating NO mapping og this index)
 * <li>getSrc(5) returns 2 <li>getSrcs(5) returns [2] </ul>
 *
 * @author J Johnson
