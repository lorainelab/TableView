/*
 * @(#) $RCSfile: DBColumnMap.java,v $ $Revision: 1.5 $ $Date: 2004/08/02 20:23:39 $ $Name: TableView1_3_2 $
 *
...
public class DBColumnMap extends CacheColumnMap {
     ...
     *
     * @param rs - the ResultSet which must be at the row corresponding to
     * rowIndexcurrent row @rowIndex - the row whose value is to be set
     */
        ...
        switch (sqlType) {
            ...
            case java.sql.Types.LONGVARCHAR: {
                ...
                try {
                    ...
                    BufferedReader rdr = new BufferedReader(rs.getCharacterStream(colIndex + 1));
    ...
    public Object getValueAt(int rowIndex) {
        ...
        switch (sqlType) {
             ...
             * java.sql.Types.DECIMAL : case java.sql.Types.NUMERIC : break;
             * case java.sql.Types.REAL : break; case java.sql.Types.DATE :
             * break;
             */
            case java.sql.Types.TIME:
