/*
 * @(#) $RCSfile: AbstractColumnFormula.java,v $ $Revision: 1.2 $ $Date: 2004/08/18 17:57:12 $ $Name: TableView1_3_2 $
 *
 ...
 * formula: <UL> <LI><b> table </b> - the TableModel on which this formula
 * operates </LI> <LI><b> row </b> - the row of the cell in the table (row
 * starts from 0) </LI> <LI><b> col </b> - the column of the cell in the table
 * (col starts from 0) </LI> <LI><b> Cells </b> - the Cells class that has a
 * number of useful static methods </LI> </UL> The formula needs to return a
 * value. Example formulas: <UL> <LI><PRE><CODE>
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.2 $ $Date: 2004/08/18 17:57:12 $ $Name: TableView1_3_2
 * $
 * @since 1.0
