...
public class IndexMapSelection implements CleanUp {
     ...
     * @param map If not null, this provides the mapping of indices between the
     ...
     * selected, if false then the source index is selected if any of its
     * associated destination indices are selected.
     */
