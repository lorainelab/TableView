...
public class IndexFractionSelected implements ListSelectionListener {
     ...
     * @param lsm if not null, the fraction is set using the current state of
     ...
     * <code>ChangeListener</code>s added with addChangeListener().
     *
     * @return all of the
     * <code>ChangeListener</code>s added or an empty array if no listeners have
     * been added
     * @see #addChangeListener
     */
