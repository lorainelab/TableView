...
public class LSMIndexMap implements IndexMap, ListSelectionListener, CleanUp {
     ...
     *
     * @param lsm The ListSelectionModel that determines which elements are in
     * the subset.
     * @param useSelected whether the subset is the selected or unselected
     * elements.
     * @param trackSelectionModel whether to change the mapping in response to
     * changes in the ListSelectionModel
     */
