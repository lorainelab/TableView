/*
 * @(#) $RCSfile: LSMIndexMap.java,v $ $Revision: 1.5 $ $Date: 2004/02/27 17:17:24 $ $Name: TableView1_3 $
 *
...
/**
 * Provides a mapping between two sets of indices, where the destination 
 * index is a subset of the source index as determined by a ListSelectionModel.
 *
 * @author       J Johnson
 * @version $Revision: 1.5 $ $Date: 2004/02/27 17:17:24 $  $Name: TableView1_3 $ 
 * @since        1.0
 */
public class LSMIndexMap implements IndexMap, ListSelectionListener, CleanUp {
   ...
   * @param lsm The ListSelectionModel that determines which elements are in the subset.
   * @param useSelected whether the subset is the selected or unselected elements.
   * @param trackSelectionModel whether to change the mapping in response to changes 
