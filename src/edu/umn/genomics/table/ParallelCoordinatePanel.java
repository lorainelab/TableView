/*
 * @(#) $RCSfile: ParallelCoordinatePanel.java,v $ $Revision: 1.36 $ $Date: 2004/08/18 17:54:08 $ $Name: TableView1_3_2 $
 *
...
import edu.umn.genomics.graph.AxisComponent;
import edu.umn.genomics.graph.InfLinearAxis;
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.36 $ $Date: 2004/08/18 17:54:08 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 * @see ColumnMap
 * @see TableContext
...
public class ParallelCoordinatePanel extends AbstractTableModelView
     ...
     *
     * @param columns the indices of the columns that should be plotted in the
     * same range.
     */
     ...
     * rows are displayed.
     *
     * @param selectedRows if not null, only row indices in the array will be
     * displayed.
     */
     ...
     *
     * @param rowDisplaySelection if not null, only row indices that are
     ...
     *
     * @param tc The index of the TableModel column on which this table will be
     * built.
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            ArrayList columnNames = new ArrayList(3);
            columnNames.add("NRSeq");
            columnNames.add("Randon ints");
            columnNames.add("NRRef");
            columnNames.add("Count");
            ArrayList<Object[]> data = new ArrayList<Object[]>();
            ArrayList pfams = new ArrayList();
            pfams.add("kinase");
            pfams.add("signalpeptide");
            pfams.add("srp");
            pfams.add("snap");
            pfams.add("actin");
            for (int i = 0; i < 30; i++) {
                ...
                v.add("SWP:0000" + i);
                v.add(new Integer((int) (Math.random() * 78)));
                v.add(pfams.get((int) (Math.random() * pfams.size())));
                v.add(new Double(Math.random() * 50.));
                data.add(v.toArray());
            }
            tm = new DefaultTableModel((Object[][]) data.toArray(), columnNames.toArray());
        }
