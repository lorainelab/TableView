/*
 * @(#) $RCSfile: TableModelProxy.java,v $ $Revision: 1.6 $ $Date: 2002/07/30 19:45:10 $ $Name: TableView1_3_2 $
 *
 ...
 * objects to have a constant reference to a TableModel instance, but have 
 * the actual TableModel supplying the data to change.
 * @author       J Johnson
 * @version $Revision: 1.6 $ $Date: 2002/07/30 19:45:10 $  $Name: TableView1_3_2 $ 
 * @since        1.0
 * @see  javax.swing.table.TableModel
 */
public class TableModelProxy implements Serializable, TableModel,TableModelListener {
  TableModel tm = null;
