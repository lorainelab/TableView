/**
 * @(#) $RCSfile: SpanPlot.java,v $ $Revision: 1.1 $ $Date: 2004/08/02 20:23:46
 * $ $Name: TableView1_3_2 $
 *
 * Center for Computational Genomics and Bioinformatics Academic Health Center,
 * University of Minnesota Copyright (c) 2000-2002. The Regents of the
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.1 $ $Date: 2004/08/02 20:23:46 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 * @see ColumnMap
 */
...
//System.err.println("SpanPlot.getPoints " + np);
    ...
    public SpanPlot(ColumnMap xColumn, ColumnMap sColumn, ColumnMap yColumn) {
        ...
        /*
         * gs = new GraphSegments(); lineModel = new LineDataModel();
         * gs.setData(lineModel); graph.addGraphItem(gs);
         */
