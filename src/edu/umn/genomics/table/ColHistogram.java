/*
 * @(#) $RCSfile: ColHistogram.java,v $ $Revision: 1.25 $ $Date: 2004/08/02 20:23:39 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.25 $ $Date: 2004/08/02 20:23:39 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 * @see ColumnMap
 * @see TableContext
...
public class ColHistogram extends AbstractTableModelView
    ...
    JCheckBox btns[] = null;
    HashMap ctoh = new HashMap(); // column to Histogram JPanel;
