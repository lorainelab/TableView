/*
 * @(#) $RCSfile: JTableView.java,v $ $Revision: 1.13 $ $Date: 2004/09/16 13:57:55 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.13 $ $Date: 2004/09/16 13:57:55 $ $Name: TableView1_3_2
 * $
 * @since 1.0
                ...
                table.getTableHeader().addMouseListener(
                        new MouseAdapter() {
                            ...
                            public void mouseClicked(MouseEvent e) {
                                ...
                                if (colIdx >= 0 && e.getX() < rect.x + sortArrow.getIconWidth()) {
                                    ...
                                    if (e.getClickCount() == 1 && column != -1) {
                                        if (e.isControlDown()) {
                                            ...
                                            boolean ascending = e.getY() <= rect.y + rect.height / 2 ? true : false;
