/*
 * @(#) $RCSfile: HistogramEvent.java,v $ $Revision: 1.1 $ $Date: 2004/08/02 20:23:41 $ $Name: TableView1_3_2 $
 *
...
public class HistogramEvent extends EventObject {
    ...
    public HistogramEvent(Object source, BinModel[] removed, BinModel[] added, boolean isAdjusting) {
        super(source);
    ...
    public String toString() {
        return super.toString() + "(removed " + removed.length
                + ",added " + added.length
