...
public class Cells {
    ...
    public static ArrayList vsort(List cells) {
        return vsort(cells, defaultComparator);
    }

    public static ArrayList vsort(List cells, Comparator comparator) {
        if (cells == null) {
            return null;
        }
        Object a[] = new Object[cells.size()];
        cells.toArray(a);
        a = sort(a, comparator);
        ArrayList v = new ArrayList(a.length);
    ...
    public static ArrayList getValuesFrom(TableModel tableModel,
        ...
        ArrayList v = new ArrayList(cnt);
        if (fc < tc) {
            for (int c = fc; c <= tc; c++) {
                if (fr < tr) {
                    for (int r = fr; r <= tr; r++) {
                        v.add(tableModel.getValueAt(r, c));
                    }
                } else {
                    for (int r = tr; r >= fr; r--) {
                        v.add(tableModel.getValueAt(r, c));
    ...
    public static ArrayList residuals(List xcells, List ycells) {
    ...
    public static ArrayList residuals(List xcells, List ycells,
        ...
        ArrayList r = new ArrayList(xcells.size());
     ...
     * collection.
     *
     * @param collection The ArrayList to examine.
     * @return The common classes for the collection members.
     */
    public static ArrayList getCommonClasses(List collection) {
    ...
    public static Class getCommonClass(List collection) {
        ArrayList commonClasses = getCommonClasses(collection);
     ...
     */
    public static ArrayList getCommonInterfaces(List collection) {
        ArrayList commonInterfaces = null;
        if (collection != null && collection.size() > 0) {
            for (ListIterator li = collection.listIterator(); li.hasNext();) {
                Object o = li.next();
