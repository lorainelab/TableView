 ...
 * all cells in the column. The Class for a column can be explicitly set by  {@link #setColumnClass}.
 *
 * @author J Johnson
...
public class TypedTableModel extends DefaultTableModel
     ...
     * this null then the model has no columns
     * @param numRows The number of rows the table holds
     * @see #setDataVector
     * @see #setValueAt
     */
     ...
     *
     * @param columnNames Array containing the names of the new columns. If this
     ...
     * @exception ClassCastException Thrown when a data element in the column is
     * not assignable to the given columnClass.
     */
     ...
     * @param row
     * @param rowData
     * @exception ClassCastException Thrown when a data element in the row is
     * not assignable to the given columnClass for the corresponding column.
     * @see #setColumnClass
     */
     ...
     *
     * @param column The index of the column position at which to insert the
