/*
 * @(#) $RCSfile: TableContext.java,v $ $Revision: 1.8 $ $Date: 2004/08/02 20:23:46 $ $Name: TableView1_3 $
 *
 ...
 * @author       J Johnson
 * @version $Revision: 1.8 $ $Date: 2004/08/02 20:23:46 $  $Name: TableView1_3 $ 
 * @since        1.0
...
public interface TableContext {
  ...
  /**
   * Get a new TableModel that contains the aggregates rows as determined by the partition.  
   * This provides the similar functionality to SQL GROUP BY
   * The new TableModel is added as a child tree node to the given TableModel.
   * @param tm the TableModel from which to derive a new TableModel
   * @param partition partitions the rows of the given TableModel for aggregate values in the new TableModel
   * @return The TableModel derived from the selected rows of the given TableModel.
   */
  ...
  //public TableModel getTableModel(TableModel tm, ListSelectionModel rows, ListSelectionModel cols);
   ...
   * @param tm The TableModel for the view
   * @param viewName The name of the type of view to create.
  ...
  //public CellMap getMap(TableModel, ListSelectionModel rows, ListSelectionModel cols);
