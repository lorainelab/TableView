/*
 * @(#) $RCSfile: ListSelectionView.java,v $ $Revision: 1.7 $ $Date: 2003/12/12 17:53:30 $ $Name: TableView1_3_2 $
 *
 ...
 * selected.  Each selected value is displayed as a horizontal line 
 * drawn at vertical position of index / listSize down from the top 
 * of the display area.  
 * @author       J Johnson
 * @version $Revision: 1.7 $ $Date: 2003/12/12 17:53:30 $  $Name: TableView1_3_2 $ 
 * @since        1.0
 * @see          javax.swing.ListSelectionModel
 */
public class ListSelectionView extends JComponent 
                               implements Serializable,ListSelectionListener {
  ListSelectionModel lsm = null;
  int listSize = 0;
  double viewWin[] = null;

  /**
   * @param selectionModel the the selection model to display.
  ...
  /**
   * Sets the row selection model to newModel and registers
