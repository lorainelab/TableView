/*
 * @(#) $RCSfile: ArrayRefColumn.java,v $ $Revision: 1.4 $ $Date: 2004/08/02 20:23:37 $ $Name: TableView1_3_2 $
 *
 ...
 * 
 * @author       J Johnson
 * @version $Revision: 1.4 $ $Date: 2004/08/02 20:23:37 $  $Name: TableView1_3_2 $ 
 * @since        1.0
...
public class ArrayRefColumn implements VirtualColumn {
   ...
   * @param array The data array for the column.
   * @exception IllegalArgumentException if array is not an array
   */
  public ArrayRefColumn(Object array) throws IllegalArgumentException {
    if (array != null && array.getClass().isArray()) {
      ...
      String s = array != null ? array.getClass().toString() + " is not an array." : "array is null.";
   ...
   * @exception IllegalArgumentException if array is not an array
   */
  public ArrayRefColumn(Object array, String columnName) throws IllegalArgumentException {
    this(array);
    setName(columnName);
  }
