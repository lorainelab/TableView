/*
 * @(#) $RCSfile: ColRef.java,v $ $Revision: 1.5 $ $Date: 2004/08/02 20:23:39 $ $Name: TableView1_3 $
 *
...
/**
 * ColRef provides a reference to a column in a TableModel.
 * It allows a VirtualTableModelProxy to hide and rearrange 
 * the columns of the TableModel.
 * 
 * @author       J Johnson
...
public class ColRef implements VirtualColumn {
  ...
  /**
   * Create a column reference with the given name that indexes into the columnIndex 
   * of the tableModel.
   * @param name A name for this column reference.
   * @param tableModel the tableModel to reference.
   * @param columnIndex the column index into the tableModel.
   */
  ...
  /**
   * Create a column reference that indexes into the columnIndex 
   * of the tableModel.
   * @param tableModel
   * @param columnIndex
   */
  ...
  /**
   * Sets the value for the cell at <code>columnIndex</code> and
   * <code>rowIndex</code>.
   *
