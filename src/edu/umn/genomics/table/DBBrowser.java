/*
 * @(#) $RCSfile: DBBrowser.java,v $ $Revision: 1.16 $ $Date: 2004/09/16 13:55:35 $ $Name: TableView1_3_2 $
 *
 ...
 *
 * @author J Johnson
 * @version $Revision: 1.16 $ $Date: 2004/09/16 13:55:35 $ $Name: TableView1_3_2
 * $
 * @since 1.0
 */
public class DBBrowser extends AbstractTableSource {
    ...
    static HashMap sqlTypeName = SQLTypeNames.getSharedInstance();
    ...
    private void setColumns(DBTable dbTable, ArrayList cols, ArrayList rows) {
...
//System.err.println("<<< setColumns");
    ...
    private void setColumns(ArrayList cols, ArrayList<Object[]> rows) {
        ...
        for (int i = 0; i < rows.size(); i++) {
            colListModel.addElement(((Object[]) rows.get(i))[0]);
        }
        colModel.setDataVector((Object[][]) rows.toArray(), cols.toArray());
    ...
    private void setPrimaryKeyInfo(Object[] tables) {
        ...
        if (tables != null && tables.length > 0) {
            for (int i = 0; i < tables.length; i++) {
                ...
                try {
                    if (i < 1) {
                        pKeyModel.set(dbmd.getPrimaryKeys(tbl.getCatalogName(), tbl.getSchemaName(), tbl.getTableName()));
                    } else {
            ...
            for (int i = 0; i < cl.length; i++) {
                try {
                    if (n < 1) {
                        pKeyModel.set(dbmd.getPrimaryKeys((String) cl[i], null, null));
                    } else {
                        pKeyModel.add(dbmd.getPrimaryKeys((String) cl[i], null, null));
                    }
                    n++;
                } catch (Exception ex) {
                }
            ...
            for (int i = 0; i < sl.length; i++) {
                try {
                    if (n < 1) {
                        pKeyModel.set(dbmd.getPrimaryKeys(null, (String) sl[i], null));
                    } else {
                        pKeyModel.add(dbmd.getPrimaryKeys(null, (String) sl[i], null));
                    }
                    n++;
                } catch (Exception ex) {
                }
    ...
    private void setForeignKeyInfo(Object[] tables) {
        ...
        if (tables != null && tables.length > 0) {
            for (int i = 0; i < tables.length; i++) {
                ...
                try {
                    if (i < 1) {
                        fKeyModel.set(dbmd.getImportedKeys(tbl.getCatalogName(), tbl.getSchemaName(), tbl.getTableName()));
                    } else {
            ...
            for (int i = 0; i < cl.length; i++) {
                try {
                    if (n < 1) {
                        fKeyModel.set(dbmd.getImportedKeys((String) cl[i], null, null));
                    } else {
                        fKeyModel.add(dbmd.getImportedKeys((String) cl[i], null, null));
                    }
                    n++;
                } catch (Exception ex) {
                }
            ...
            for (int i = 0; i < sl.length; i++) {
                try {
                    if (n < 1) {
                        fKeyModel.set(dbmd.getImportedKeys(null, (String) sl[i], null));
                    } else {
                        fKeyModel.add(dbmd.getImportedKeys(null, (String) sl[i], null));
                    }
                    n++;
                } catch (Exception ex) {
                }
    ...
    private void setExportedKeyInfo(Object[] tables) {
        ...
        if (tables != null && tables.length > 0) {
            for (int i = 0; i < tables.length; i++) {
                ...
                try {
                    if (i < 1) {
                        xKeyModel.set(dbmd.getExportedKeys(tbl.getCatalogName(), tbl.getSchemaName(), tbl.getTableName()));
                    } else {
            ...
            for (int i = 0; i < cl.length; i++) {
                try {
                    if (n < 1) {
                        xKeyModel.set(dbmd.getExportedKeys((String) cl[i], null, null));
                    } else {
                        xKeyModel.add(dbmd.getExportedKeys((String) cl[i], null, null));
                    }
                    n++;
                } catch (Exception ex) {
                }
            ...
            for (int i = 0; i < sl.length; i++) {
                try {
                    if (n < 1) {
                        xKeyModel.set(dbmd.getExportedKeys(null, (String) sl[i], null));
                    } else {
                        xKeyModel.add(dbmd.getExportedKeys(null, (String) sl[i], null));
                    }
                    n++;
                } catch (Exception ex) {
                }
    ...
    private void setIndexInfo(DBTable dbTable, ArrayList cols, ArrayList rows) {
        ...
        try {
            ...
            for (int r = 0; r < itm.getRowCount(); r++) {
                ArrayList row = new ArrayList(13);
    ...
    private void setDefaultModel(DefaultTableModel model, ArrayList cols, ArrayList<Object[]> rows) {
        if (rows == null || rows.size() < 1) {
            model.setRowCount(0);
            return;
        }
        model.setDataVector((Object[][]) rows.toArray(), cols.toArray());
    }
