/*
 * @(#) $RCSfile: SelectableCellMap.java,v $ $Revision: 1.2 $ $Date: 2002/07/30 19:45:08 $ $Name: TableView1_3_2 $
 *
...
/**
 * SelectableCellMap maps the values of a Collection of values to a numeric range. 
 ...
 * 
 * @author       J Johnson
 * @version $Revision: 1.2 $ $Date: 2002/07/30 19:45:08 $  $Name: TableView1_3_2 $ 
 * @since        1.0
 * @see  SetOperator 
...
public interface SelectableCellMap extends CellMap {
  ...
  /**
   * Select the indices that are mapped in the given range of this map.  
   * The selected indices are set in the given ListSelectionModel.
  ...
  /** 
   * Select the indices that are mapped in the given range of this map.  
   * The selected rows are set in the ListSelection Model that was set for this 
   * map.
   * @param from the start of the selected range
   * @param to the end of the selected range
   * @see #setSetOperator
