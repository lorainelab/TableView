 ...
 * partition on that list of elements. <br>For example, given partition index
 * array :
 * <code>
 *  [ 1 2 2 0 1 0 5 3 1 5 ]
 * </code> in which each of the 10 elements of the list are assigned to one of 6
 * parts of the partition. <ul> <li>getDstSize() returns 6 The number of
 * partitions (0,...,5) <li>getDst(i) returns the partition the value at postion
 * i is assaigned. <li>getDst(0) returns 1 <li>getDst(1) returns 2 <li>getDst(2)
 * returns 2 <li>getDst(3) returns 0 <li>getDst(4) returns 1 <li>getDst(5)
 * returns 0 <li>getDst(6) returns 5 <li>getDst(7) returns 3 <li>getDst(8)
 * returns 1 <li>getDst(9) returns 5 <li>getSrcSize() returns 10 <li>getSrcs(i)
 * returns the array indices assigned to the i partition. <li>getSrcs(0) returns
 * [3 5] <li>getSrcs(1) returns [0 4 8] <li>getSrcs(2) returns [1 2]
 * <li>getSrcs(3) returns [7] <li>getSrcs(4) returns [] <li>getSrcs(5) returns
 * [6 9] </ul>
 *
 * @author J Johnson
