/*
 * @(#) $RCSfile: VirtualTableModel.java,v $ $Revision: 1.8 $ $Date: 2004/08/02 20:23:47 $ $Name: TableView1_3_2 $
 *
...
/**
 * VirtualTableModel provides an interface to hide columns, reorder columns,
 * or add VirtualColumns of formulas in a TableModel.
 *
 * @author       J Johnson
 * @version $Revision: 1.8 $ $Date: 2004/08/02 20:23:47 $  $Name: TableView1_3_2 $ 
 * @since        1.0
...
public interface VirtualTableModel extends TableModel {
   ...
   * @param columnName the name given this column.
