/*
 * @(#) $RCSfile: AbstractHistogramModel.java,v $ $Revision: 1.1 $ $Date: 2004/08/02 20:23:36 $ $Name: TableView1_3_2 $
 *
...
public abstract class AbstractHistogramModel implements HistogramModel {
     ...
     *
     * @param indices an array that locates a particular bin.
     * @param listSelectModel The selection model to change with the bin
     * selection, if null a new ListSelectionModel will be allocated.
     * @param setOperator The Set operation used when applying the new
     * selection.
     ...
     * Notify Listeners of a change.
     *
     * @param isAdjusting Whether this model is still in the process of
     * changing.
     */
